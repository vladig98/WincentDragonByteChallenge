...
string path = "D:\\Wincent Dragonbyte\\2026\\WaterSlides";
string[] inputFiles = ["W0_sample.in", "W1.in", "W2.in", "W3.in", "W4.in"];
string[] outputFiles = ["W0.out", "W1.out", "W2.out", "W3.out", "W4.out"];
